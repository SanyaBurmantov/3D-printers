        ...
        <div className="relative flex flex-col items-center bg-white">
            ...
            >
                <div className={styles.navigation}>
                    <Link className={styles.navigationItem}  href="/create_order"><button className="z-50 inline-flex items-center justify-center px-6 py-3 text-base font-medium text-center rounded hover:bg-blue-dark lg:px-7">Сделать заказ</button></Link>
