                                ...
                                <div className="mb-12 max-w-[570px] lg:mb-0">
                                    ...
                                    <div className="max-w-2xl mx-auto p-6">
                                        ...
                                        <h2 className="mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                                            ...
                                            промышленности, так и в любительских проектах благодаря своей
                                            доступности и
                                            простоте.
                                        </h2>
                                        ...
                                        <ol className="list-decimal list-inside mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                                            <li className="mb-2">Подготовка модели: 3D-модель создается с помощью
                                                CAD-программ и затем экспортируется в формат, совместимый с
                                                3D-принтером
                                                (обычно STL).
                                            </li>
                                            <li className="mb-2">Расплавление материала: Нагревательный элемент
                                                принтера
                                                расплавляет термопластический филамент, который подается через
                                                экструдер.
                                            </li>
                                            <li className="mb-2">Нанесение слоев: Расплавленный материал наносится
                                                на
                                                платформу в виде тонких слоев, постепенно формируя объект. Каждый
                                                слой
                                                охлаждается и затвердевает, что позволяет создавать сложные
                                                геометрические формы.
                                            </li>
                                            <li>Завершение печати: После завершения процесса печати объект
                                                извлекается
                                        ...
                                        <ul className="list-disc list-inside mb-4 text-base leading-relaxed text-body-color dark:text-dark-6">
                                            <li className="mb-2">Доступность: Принтеры FDM/FFF относительно недороги
                                                и
                                        ...
                                        <ul className="list-disc list-inside mb-9 text-base leading-relaxed text-body-color dark:text-dark-6">
                                            <li className="mb-2">Качество печати: Ограничения в точности и
                                                детализации
                                                по сравнению с другими технологиями, такими как SLA.
                                            </li>
                                            <li className="mb-2">Скорость: Процесс может занимать значительное
                                                время,
                                                особенно для крупных объектов.
                                            </li>
                                            <li>Свойства материала: Некоторые термопласты могут быть менее прочными
                                                или
